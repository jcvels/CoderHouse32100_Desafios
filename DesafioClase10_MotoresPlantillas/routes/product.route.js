...
router.get('/', (req, res) => {
    res.render(`${process.argv[2]}/products-form`);
});

router.get('/productos', (req, res) => {
    products_db.getAll()
        .then( products => res.render(`${process.argv[2]}/products-list`, {products}) )
        .catch( error => res.status(500).render(`${process.argv[2]}/error`, {error}) )
});
...
router.get('/error', (req, res) => {
    ...
    res.status(500).render(`${process.argv[2]}/error`, {error})
});
